...
import { SitePageContentProvider } from "./site-page-content";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang={locale}><body>
    ...
    <AuthProvider><I18nProvider initialLocale={locale}><SiteSettingsProvider><SiteContentProvider><SitePageContentProvider><Nav /><PageTransition>{children}</PageTransition><Footer /><GuideLauncher /></SitePageContentProvider></SiteContentProvider></SiteSettingsProvider></I18nProvider></AuthProvider>
  </body></html>;
}
