...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang={locale}><body>
    ...
    <AuthProvider><I18nProvider initialLocale={locale}><SiteSettingsProvider><SiteContentProvider><Nav /><PageTransition>{children}</PageTransition><Footer /><GuideLauncher /></SiteContentProvider></SiteSettingsProvider></I18nProvider></AuthProvider>
  </body></html>;
}
