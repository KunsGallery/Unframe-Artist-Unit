...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang={locale}><body>
    ...
    <AuthProvider><I18nProvider initialLocale={locale}><SiteSettingsProvider><Nav /><PageTransition>{children}</PageTransition><Footer /></SiteSettingsProvider></I18nProvider></AuthProvider>
  </body></html>;
}
